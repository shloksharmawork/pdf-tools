...
export default function PdfToJpg() {
    ...
    const handleConvert = async () => {
        ...
        try {
            ...
            setStatus('completed')
            // Determine filename extension based on response type if possible, or just default to zip/jpg logic
            // The file name from header might be available, usually downloadFile handles blob.
            // But we can check response.headers['content-type']
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-[60vh] px-4">
            <h1 className="text-3xl font-bold mb-8 text-gray-800">PDF to JPG</h1>

            <div className="w-full max-w-4xl bg-white rounded-xl shadow-lg p-8">
                <UploadBox onFileSelect={handleFileSelect} description="Drop PDF to convert to JPG" />
                    ...
                    <FadeIn>
                        <div className="mt-8 max-w-md mx-auto">
                            ...
                            {status === 'idle' && (
                                ...
                                >
                                    Convert to JPG
                                    <FileImage className="ml-2 w-4 h-4" />
                                </button>
                            )}
                            ...
                            {(status === 'uploading' || status === 'processing') && (
                                <div className="space-y-3">
                                    <p className="text-sm text-gray-500 text-center font-medium">
                                        {status === 'processing' ? 'Converting Pages...' : 'Uploading PDF...'}
                                    </p>
                            ...
                            {status === 'completed' && (
                                <div className="text-center bg-green-50 p-6 rounded-xl border border-green-100">
                                    ...
                                    <p className="text-sm text-green-600 mb-4">Your images are ready.</p>
                                    <button
            ...
            <div className="mt-12 max-w-2xl text-center space-y-4 text-gray-500">
                <p>Convert your PDF pages into high-quality JPG images instantly.</p>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                    <div className="p-4 bg-gray-50 rounded-lg">
                        <span className="font-semibold text-gray-700 block mb-1">High Quality</span>
                        Original resolution preserved
                    </div>
                    <div className="p-4 bg-gray-50 rounded-lg">
                        <span className="font-semibold text-gray-700 block mb-1">Fast</span>
                        Convert nearly instantly
                    </div>
                    <div className="p-4 bg-gray-50 rounded-lg">
