...
export default function WordToPdf() {
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-[60vh] px-4">
            <h1 className="text-3xl font-bold mb-8 text-gray-800">Word to PDF</h1>

            <div className="w-full max-w-4xl bg-white rounded-xl shadow-lg p-8">
                <UploadBox
                    onFileSelect={handleFileSelect}
                    description="Drop Word document to convert to PDF"
            ...
            <div className="mt-12 max-w-2xl text-center space-y-4 text-gray-500">
                <p>Convert your Word documents (.doc, .docx) to PDF format seamlessly.</p>
            </div>
        </div>
    )
}
